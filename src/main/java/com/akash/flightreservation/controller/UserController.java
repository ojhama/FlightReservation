...
import com.akash.flightreservation.entities.User;
import com.akash.flightreservation.repos.UserRepository;
import com.akash.flightreservation.services.SecurityService;
...
public class UserController {
	...
	public String login(@RequestParam("email") String email, @RequestParam("password") String password,
		 ...
		 * (user.getPassword().equals(password)) { return "findFlight"; } else {
